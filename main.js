...
client.on("ready", () => {
  console.log("SkullBot has been started");
});
  ...
  try {
    if (config.pmpermit_enabled == "true") {
      ...
      if (
        ...
        !otherChat.isMe &&
        !msg.body.startsWith("!") &&
        !msg.body.endsWith("_Powered by SkullBot")
      ) {
...
app.get("/", (req, res) => {
  res.send(
    '<h1>This server is powered by SkullBot<br><a href="https://github.com/hackelite01/Skull-WA-Bot">https://github.com/hackelite01/Skull-WA-Bot</a></h1>'
  );
});

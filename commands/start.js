...
async function get(battery, phn_info) {
  ...
  return {
    msg:
      `*SkullBot*\n\nThis chat is Powered By **\n\n*Battery:* ${batttxt}\n*Device:* ${phn_info.device_manufacturer} ${phn_info.device_model}\n*WA Version:* ${phn_info.wa_version}\n*SkullBot Version:* ${packageJson.version}\n*Pmpermit:* ${config.pmpermit_enabled}\n\n*Made By:* Mayank Rajput\n\n*Official Repository Url *\n` +
      "```https://github.com/hackelite01/Skull-Wa-Bot```",
    mimetype: "image/jpeg",
    data: Buffer.from(
      (
        await axios.get("https://telegra.ph/file/8521d92b36ebe13ae3095.jpg", {
...
module.exports = {
  ...
  commandType: "info",
  isDependent: false,
  help: "Get information about your SkullBot",
  execute,
};
